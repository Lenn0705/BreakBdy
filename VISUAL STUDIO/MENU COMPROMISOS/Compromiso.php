...
?>
  ...
  <div id="menu-barra-der">
    ...
    <?php foreach($resultadoConsultaColeccion as $documento){?>
        ...
        <p>Hora:<?php echo $documento['hora']['horaInicial']." - ". $documento['hora']['horaFinal']. "<br>";?></p>
    ...
    <div id="barra-control">
     <section id="control">
        <button onclick="location.href='/Breakbdy/VISUAL STUDIO/MENU COMPROMISOS/FORMULARIO CREARCrearCompromisos.php'" id="botonRedireccionar">Crear Compromiso
      </button>
