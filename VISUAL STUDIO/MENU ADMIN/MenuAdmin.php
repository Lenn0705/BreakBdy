...
<a>
  ...
  <input type="submit" name="EliminarUsuario" class="boton2" value="Eliminar Usuario">
  <input type="submit" name="EditarUsuario" class="boton2" value="Editar Usuario">
  </form>
  <?php
  if(isset($_POST['EliminarUsuario'])){
    header("Location:/VISUAL STUDIO/MENU ADMIN/BorrarUsuario.php?id=".$documento['_id']."");
  }

  if(isset($_POST['EditarUsuario'])){
    header("location:/VISUAL STUDIO/MENU ADMIN/EditarUsuario.php?id=". $documento['_id']."");
